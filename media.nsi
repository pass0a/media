...
!define PRODUCT_NAME "Media"
!define PRODUCT_VERSION "1.1"
!define PRODUCT_PUBLISHER "passoa.auto"
!define PRODUCT_WEB_SITE "https://wool.gitee.io"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\Media"
...
FunctionEnd
Function unlockApp
   ExecWait "$INSTDIR\unlock.bat"   ;若不存在，执行静默安装
   ;;Delete "$INSTDIR\sn.js"
FunctionEnd

Name "${PRODUCT_NAME} ${PRODUCT_VERSION}"
OutFile "MediaSetup.exe"
InstallDir "$PROGRAMFILES\Media"
...
Section -AdditionalIcons
  ...
  CreateShortCut "$SMPROGRAMS\Media\Website.lnk" "$INSTDIR\${PRODUCT_NAME}.url"
  CreateShortCut "$SMPROGRAMS\Media\Uninstall.lnk" "$INSTDIR\uninst.exe"
SectionEnd
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\Media\Uninstall.lnk"
  Delete "$SMPROGRAMS\Media\Website.lnk"
  Delete "$DESKTOP\Media.lnk"
  Delete "$SMPROGRAMS\Media\Media.lnk"

  RMDir "$SMPROGRAMS\Media"
  RMDir "$INSTDIR"
